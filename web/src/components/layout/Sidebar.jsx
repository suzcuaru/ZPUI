...
export default function Sidebar({ activePage, onNavigate, onOpenChecker, onAutoSelect, onOpenHealth, onOpenHelp, healthWarn, hasLogErrors, status, showToast, onOpenLogs, zapretLoading, onZapretToggle }) {
  const { t } = useT();
  ...
  const xbox = useServiceToggle('xboxdns', xRun, showToast);

  const svcMap = {
    zapret: { running: zRun, toggle: onZapretToggle, loading: zapretLoading },
    ...
    <aside className="sidebar">
      ...
      {healthWarn && (
        <button
          ...
          aria-label="health"
          data-tooltip={t('sidebar.healthLabel')}
          data-tooltip-pos="right"
        >
      ...
      <button
        ...
        data-tooltip={zRun ? t('sidebar.autoSelectLabel') : t('sidebar.autoSelectDisabledTip')}
        data-tooltip-pos="right"
      >
      ...
      <button
        ...
        aria-label="checker"
        data-tooltip={t('sidebar.checkerLabel')}
        data-tooltip-pos="right"
      >
      ...
      <button
        className={'sidebar-footer-btn' + (hasLogErrors ? ' has-err' : '')}
        onClick={onOpenLogs}
        aria-label="logs"
        data-tooltip={t('sidebar.logsLabel')}
        data-tooltip-pos="right"
      >
      ...
      <button
        ...
        onClick={onOpenHelp}
        aria-label="help"
        data-tooltip={t('sidebar.helpLabel')}
        data-tooltip-pos="right"
      >
