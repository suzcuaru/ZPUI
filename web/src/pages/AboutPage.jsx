    ...
    <div className="about-page">
      ...
      <div className="about-info-grid">
        <div className="about-info-card">
          <div className="about-info-icon" style={{ background: 'var(--accent-bg)', color: 'var(--accent)' }}>
        ...
        <div className="about-info-card">
          <div className="about-info-icon" style={{ background: 'var(--success-bg)', color: 'var(--success)' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
            </svg>
          </div>
        ...
        <div className="about-info-card">
          <div className="about-info-icon" style={{ background: 'var(--warning-bg)', color: 'var(--warning)' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="about-info-card">
          <div className="about-info-icon" style={{ background: 'var(--danger-bg)', color: 'var(--danger)' }}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <Card className="settings-card" style={{ marginTop: 16 }}>
        <div className="settings-card-header">
          <h3>Обновления</h3>
          <p>Проверка и установка новых версий</p>
        </div>
