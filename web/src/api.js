...
const POST_ROUTES = {
  ...
  '/api/components/download': (app, b) => app.DownloadUpdate(b.name || ''),
  '/api/components/verify': (app, b) => app.VerifyUpdate(b.name || ''),
  '/api/components/install': (app, b) => app.InstallUpdate(b.name || ''),
  '/api/components/release-info': (app, b) => app.GetReleaseInfo(b.name || ''),
