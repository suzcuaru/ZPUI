...
let _zapret = { state: 'idle', current: null, latest: null, bestVersion: null };
...
export async function checkZapretUpdate() {
  _zapret = { state: 'checking', current: _zapret.current, latest: _zapret.latest, bestVersion: _zapret.bestVersion };
  notify();
  ...
  _zapret = {
    ...
    bestVersion: d?.best_version || null,
  };
  notify();
}
